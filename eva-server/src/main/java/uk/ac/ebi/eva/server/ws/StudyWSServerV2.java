...
public class StudyWSServerV2 {
    ...
    public ResponseEntity getBrowsableStudies(
        ...
        if (totalNumberOfResults == 0) {
            return new ResponseEntity(PagedModel.of(Collections.EMPTY_LIST, new PagedModel.PageMetadata(
        ...
        PagedModel pagedResources = buildPagedResources(uniqueStudies, species, assembly, pageMetadata);
    ...
    private PagedModel buildPagedResources(List<VariantStudySummary> uniqueStudies, String species,
                                           String assembly, PagedModel.PageMetadata pageMetadata) {

        PagedModel pagedResources = PagedModel.of(uniqueStudies, pageMetadata);
    ...
    private Link createPaginationLink(String species, String assembly, int pageNumber, int pageSize, String linkName) {
        return linkTo(methodOn(StudyWSServerV2.class).getBrowsableStudies(species, assembly,
                pageNumber, pageSize))
                .withRel(linkName);
    }
}
