...
public class GeneWSServerV2IntegrationTest extends AbstractIntegrationTest {
    ...
    public void tearDown() {
        testDataLoader.cleanUp("testFeatures", "testVariants", "testFiles", "testAnnotations", "testMetadata");
    }
